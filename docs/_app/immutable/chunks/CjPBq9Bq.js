		...
		if (typeof nt != 'string' && !Array.isArray(nt)) {
			for (const x in nt)
				if (x !== 'default' && !(x in J)) {
					...
					lt && Object.defineProperty(J, x, lt.get ? lt : { enumerable: !0, get: () => nt[x] });
				}
		}
	}
				...
				(function (l, nt) {
					...
					function C(t, e) {
						Object.prototype.hasOwnProperty.call(t, 'options') ||
							(t.options = t.options ? lt(t.options) : {});
					...
					function ii(t) {
						var e = +new Date(),
							i = Math.max(0, 16 - (e - ei));
						return ((ei = e + i), window.setTimeout(t, i));
					}
					var pe = window.requestAnimationFrame || me('RequestAnimationFrame') || ii,
						ni =
							window.cancelAnimationFrame ||
							me('CancelAnimationFrame') ||
							me('CancelRequestAnimationFrame') ||
							function (t) {
								window.clearTimeout(t);
							};
					function D(t, e, i) {
						if (i && pe === ii) t.call(e);
						else return pe.call(window, S(t, e));
					}
					function G(t) {
						t && ni.call(window, t);
					}
					...
					((ot.extend = function (t) {
						...
						for (var o in this)
							Object.prototype.hasOwnProperty.call(this, o) &&
								...
								(e[o] = this[o]);
						return (
							t.statics && x(e, t.statics),
							t.includes && (wn(t.includes), x.apply(null, [n].concat(t.includes))),
							x(n, t),
							delete n.statics,
							delete n.includes,
							n.options && ((n.options = i.options ? lt(i.options) : {}), x(n.options, t.options)),
							(n._initHooks = []),
						...
						_off: function (t, e, i) {
							...
							if (this._events && ((n = this._events[t]), !!n)) {
								if (arguments.length === 1) {
									if (this._firingCount) for (o = 0, s = n.length; o < s; o++) n[o].fn = E;
								...
								if (r !== !1) {
									var a = n[r];
									(this._firingCount && ((a.fn = E), (this._events[t] = n = n.slice())),
										n.splice(r, 1));
								}
							}
						},
					...
					((U.addEventListener = U.on),
						(U.removeEventListener = U.clearAllEventListeners = U.off),
						(U.addOneTimeEventListener = U.once),
						(U.fireEvent = U.fire),
						(U.hasEventListeners = U.listens));
					var kt = ot.extend(U);
					function m(t, e, i) {
					...
					z.prototype = {
						extend: function (t) {
							var e, i;
							if (!t) return this;
							if (t instanceof m || typeof t[0] == 'number' || 'x' in t) e = i = _(t);
							else if (((t = F(t)), (e = t.min), (i = t.max), !e || !i)) return this;
							return (
								!this.min && !this.max
						...
						contains: function (t) {
							var e, i;
							return (
								typeof t[0] == 'number' || t instanceof m ? (t = _(t)) : (t = F(t)),
						...
						pad: function (t) {
							...
							return F(_(e.x - n, e.y - o), _(i.x + n, i.y + o));
						},
						equals: function (t) {
							return t
								? ((t = F(t)),
					...
					var we = document.documentElement.style,
						...
						Pn = Kt && !document.addEventListener,
						...
						Tn = ui && $('Google') && Ln < 537 && !('AudioNode' in window),
						Pe = !!window.opera,
						ci = !hi && $('chrome'),
						fi = $('gecko') && !xe && !Pe && !Kt,
						bn = !ci && $('safari'),
						di = $('phantom'),
						_i = 'OTransition' in we,
						Mn = navigator.platform.indexOf('Win') === 0,
						mi = Kt && 'transition' in we,
						Le = 'WebKitCSSMatrix' in window && 'm11' in new window.WebKitCSSMatrix() && !li,
						pi = 'MozPerspective' in we,
						Sn = !window.L_DISABLE_3D && (mi || Le || pi) && !_i && !di,
						Zt = typeof orientation < 'u' || $('mobile'),
						Cn = Zt && xe,
						zn = Zt && Le,
						vi = !window.PointerEvent && window.MSPointerEvent,
						gi = !!(window.PointerEvent || vi),
						yi = 'ontouchstart' in window || !!window.TouchEvent,
						kn = !window.L_NO_TOUCH && (yi || gi),
						En = Zt && Pe,
						Zn = Zt && fi,
						On =
						...
						In = (function () {
							...
							try {
								...
								(window.addEventListener('testPassiveEventSupport', E, e),
									window.removeEventListener('testPassiveEventSupport', E, e));
							} catch {}
							return t;
						})(),
						An = (function () {
						...
						Rn = navigator.platform.indexOf('Mac') === 0,
						Dn = navigator.platform.indexOf('Linux') === 0;
					function $(t) {
					...
					var f = {
						...
						wi = f.msPointer ? 'MSPointerDown' : 'pointerdown',
						xi = f.msPointer ? 'MSPointerMove' : 'pointermove',
						Pi = f.msPointer ? 'MSPointerUp' : 'pointerup',
						Li = f.msPointer ? 'MSPointerCancel' : 'pointercancel',
						be = { touchstart: wi, touchmove: xi, touchend: Pi, touchcancel: Li },
						Ti = { touchstart: Vn, touchmove: Yt, touchend: Yt, touchcancel: Yt },
						wt = {},
						bi = !1;
					function Fn(t, e, i) {
						return (
							e === 'touchstart' && Gn(),
							Ti[e]
								? ((i = Ti[e].bind(this, i)), t.addEventListener(be[e], i, !1), i)
								: (console.warn('wrong event specified:', e), E)
						);
					}
					function Hn(t, e, i) {
						if (!be[e]) {
					...
					function Gn() {
						bi ||
							(document.addEventListener(wi, Wn, !0),
							document.addEventListener(xi, Un, !0),
							document.addEventListener(Pi, Mi, !0),
							document.addEventListener(Li, Mi, !0),
							(bi = !0));
					}
					function Yt(t, e) {
					...
					function I(t, e) {
						((t._leaflet_pos = e),
							f.any3d ? mt(t, e) : ((t.style.left = e.x + 'px'), (t.style.top = e.y + 'px')));
					}
					function pt(t) {
					...
					function Oe(t) {
						...
						t.style &&
							(te(),
							($t = t),
							(Ze = t.style.outlineStyle),
							(t.style.outlineStyle = 'none'),
							p(window, 'keydown', te));
					}
					function te() {
						$t &&
							(($t.style.outlineStyle = Ze),
							($t = void 0),
							(Ze = void 0),
							M(window, 'keydown', te));
					}
					...
					function p(t, e, i, n) {
						if (e && typeof e == 'object') for (var o in e) Be(t, o, e[o], i);
						else {
							e = _t(e);
					...
					function M(t, e, i, n) {
						...
						else if (e && typeof e == 'object') for (var o in e) Ne(t, o, e[o], i);
						else if (((e = _t(e)), arguments.length === 2))
							ki(t, function (a) {
								return _e(e, a) !== -1;
							});
						else for (var s = 0, r = e.length; s < r; s++) Ne(t, e[s], i, n);
						return this;
					}
					function ki(t, e) {
						for (var i in t[tt]) {
							...
							: f.touch && e === 'dblclick'
								...
								: 'addEventListener' in t
									? e === 'touchstart' || e === 'touchmove' || e === 'wheel' || e === 'mousewheel'
										? t.addEventListener(Ae[e] || e, s, f.passiveEvents ? { passive: !1 } : !1)
					...
					function Rt(t) {
						return (
							p(t, 'mousedown touchstart dblclick contextmenu', vt),
						...
						w = kt.extend({
							...
							initialize: function (t, e) {
								((e = C(this, e)),
									...
									e.center && e.zoom !== void 0 && this.setView(y(e.center), e.zoom, { reset: !0 }),
									this.callInitHooks(),
									(this._zoomAnimated =
										Ot && f.any3d && !f.mobileOpera && this.options.zoomAnimation),
									this._zoomAnimated &&
										(this._createAnimProxy(), p(this._proxy, Si, this._catchTransitionEnd, this)),
									this._addLayers(this.options.layers));
							},
							setView: function (t, e, i) {
								if (
									((e = e === void 0 ? this._zoom : this._limitZoom(e)),
									(t = this._limitCenter(y(t), e, this.options.maxBounds)),
									(i = i || {}),
									this._stop(),
									this._loaded && !i.reset && i !== !0)
								) {
									i.animate !== void 0 &&
										((i.zoom = x({ animate: i.animate }, i.zoom)),
										(i.pan = x({ animate: i.animate, duration: i.duration }, i.pan)));
									var n =
										this._zoom !== e
							...
							setZoomAround: function (t, e, i) {
								var n = this.getZoomScale(e),
									...
									s = t instanceof m ? t : this.latLngToContainerPoint(t),
							...
							_getBoundsCenterZoom: function (t, e) {
								...
								var i = _(e.paddingTopLeft || e.padding || [0, 0]),
									n = _(e.paddingBottomRight || e.padding || [0, 0]),
							...
							flyTo: function (t, e, i) {
								...
								function g(A) {
									var fe = A ? -1 : 1,
										Wo = A ? h : a,
										Uo = h * h - a * a + fe * d * d * u * u,
										Go = 2 * Wo * d * u,
										Xe = Uo / Go,
										mn = Math.sqrt(Xe * Xe + 1) - Xe,
										Vo = mn < 1e-9 ? -18 : Math.log(mn);
									return Vo;
								}
								function R(A) {
								...
								var Fo = Date.now(),
									dn = (g(1) - W) / c,
									Ho = i.duration ? 1e3 * i.duration : 1e3 * dn * 0.8;
								function _n() {
									var A = (Date.now() - Fo) / Ho,
										fe = Do(A) * dn;
									A <= 1
										? ((this._flyToFrame = D(_n, this)),
											this._move(
							...
							panInsideBounds: function (t, e) {
								...
								var i = this.getCenter(),
									n = this._limitCenter(i, this._zoom, O(t));
							...
							panInside: function (t, e) {
								...
								var i = _(e.paddingTopLeft || e.padding || [0, 0]),
									...
									a = F([r.min.add(i), r.max.subtract(n)]),
									h = a.getSize();
								if (!a.contains(s)) {
									this._enforcingBounds = !0;
							...
							getBoundsZoom: function (t, e, i) {
								...
								var n = this.getZoom() || 0,
									...
									u = F(this.project(a, n), this.project(r, n)).getSize(),
									c = f.any3d ? this.options.zoomSnap : 1,
									d = h.x / u.x,
									g = h.y / u.y,
									R = e ? Math.max(d, g) : Math.min(d, g);
								return (
									(n = this.getScaleZoom(R, n)),
									c &&
							...
							project: function (t, e) {
								return (
									(e = e === void 0 ? this._zoom : e),
									this.options.crs.latLngToPoint(y(t), e)
								);
							},
							unproject: function (t, e) {
								return (
									(e = e === void 0 ? this._zoom : e),
									this.options.crs.pointToLatLng(_(t), e)
								);
							},
							...
							_initPanes: function () {
								...
								((this._paneRenderers = {}),
									...
									this.options.markerZoomAnimation ||
										(v(t.markerPane, 'leaflet-zoom-hide'), v(t.shadowPane, 'leaflet-zoom-hide')));
							},
							...
							_findEventTargets: function (t, e) {
								for (
									...
									if (
										(n && n.listens(e, !0) && ((o && !De(s, t)) || (i.push(n), o))) ||
										s === this._container
									)
										break;
									s = s.parentNode;
							...
							_getBoundsOffset: function (t, e, i) {
								var n = F(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i)),
							...
							_addItem: function (t) {
								...
								(t.overlay
									? ((n = document.createElement('input')),
										...
										(n.defaultChecked = i))
									: (n = this._createRadioElement('leaflet-base-layers_' + P(this), i)),
					...
					(w.mergeOptions({ zoomControl: !0 }),
						w.addInitHook(function () {
							this.options.zoomControl &&
								((this.zoomControl = new Fe()), this.addControl(this.zoomControl));
						}));
					var io = function (t) {
							return new Fe(t);
						},
						...
						He = Y.extend({
							...
							onAdd: function (t) {
								((t.attributionControl = this),
									(this._container = T('div', 'leaflet-control-attribution')),
									Rt(this._container));
					...
					var ro = { Events: U },
						...
						ft = kt.extend({
							...
							enable: function () {
								this._enabled ||
									(p(this._dragStartTarget, Ni, this._onDown, this), (this._enabled = !0));
							},
							disable: function () {
								this._enabled &&
									(ft._dragging === this && this.finishDrag(!0),
									M(this._dragStartTarget, Ni, this._onDown, this),
									(this._enabled = !1),
									(this._moved = !1));
							},
							_onDown: function (t) {
							...
							finishDrag: function (t) {
								(Z(document.body, 'leaflet-dragging'),
									...
									M(document, 'mousemove touchmove', this._onMove, this),
									M(document, 'mouseup touchend touchcancel', this._onUp, this),
									Ee(),
									Bt());
						...
						for (a = 0; a < 4; a++) {
							for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
								((h = t[s]),
									(u = t[r]),
									h._code & d
										? u._code & d || ((g = ee(u, h, d, e, i)), (g._code = yt(g, e)), n.push(g))
										: (u._code & d && ((g = ee(u, h, d, e, i)), (g._code = yt(g, e)), n.push(g)),
											n.push(h)));
							t = n;
						}
					...
					var ao = { __proto__: null, clipPolygon: Ri, polygonCenter: Di, centroid: We };
					function Fi(t, e) {
					...
					function Vi(t, e) {
						...
						for (i = 0, n = 0; i < R - 1; i++) n += B[i].distanceTo(B[i + 1]) / 2;
						if (n === 0) u = B[0];
						else
							for (i = 0, s = 0; i < R - 1; i++)
					...
					var fo = {
						...
						_o = { __proto__: null, LonLat: Ge, Mercator: Ve, SphericalMercator: ve },
						mo = x({}, ct, {
							code: 'EPSG:3395',
							projection: Ve,
							transformation: (function () {
					...
					var Lt = X.extend({
							...
							addLayer: function (t) {
								return this.hasLayer(t)
									...
									: (t.addEventParent(this),
										Lt.prototype.addLayer.call(this, t),
							...
							removeLayer: function (t) {
								return this.hasLayer(t)
									? (t in this._layers && (t = this._layers[t]),
										...
										Lt.prototype.removeLayer.call(this, t),
						...
						Tt = ot.extend({
							...
							_setIconStyles: function (t, e) {
								...
								var o = _(n),
									s = _(
										(e === 'shadow' && i.shadowAnchor) || i.iconAnchor || (o && o.divideBy(2, !0))
									);
					...
					var Ht = Tt.extend({
							...
							_getIconUrl: function (t) {
								return (
									typeof Ht.imagePath != 'string' && (Ht.imagePath = this._detectIconPath()),
									(this.options.imagePath || Ht.imagePath) + Tt.prototype._getIconUrl.call(this, t)
								);
							},
						...
						ji = et.extend({
							...
							addHooks: function () {
								...
								(this._draggable || (this._draggable = new ft(t, t, !0)),
									this._draggable
										.on(
											{
							...
							_adjustPan: function (t) {
								...
								if (!h.contains(s)) {
									...
									(i.panBy(u, { animate: !1 }),
										...
										I(e._icon, this._draggable._newPos),
										this._onDrag(t),
							...
							_onPreDrag: function (t) {
								this._marker.options.autoPan &&
									(G(this._panRequest), (this._panRequest = D(this._adjustPan.bind(this, t))));
							},
							_onDrag: function (t) {
								var e = this._marker,
									i = e._shadow,
						...
						ie = X.extend({
							...
							_removeIcon: function () {
								(this.options.riseOnHover &&
									...
									this.options.autoPanOnFocus && M(this._icon, 'focus', this._panOnFocus, this),
									k(this._icon),
							...
							_setPos: function (t) {
								(this._icon && I(this._icon, t),
									this._shadow && I(this._shadow, t),
							...
							_initInteraction: function () {
								if (
									...
									(v(this._icon, 'leaflet-interactive'), this.addInteractiveTarget(this._icon), ji)
								) {
							...
							_panOnFocus: function () {
								...
								if (t) {
									var e = this.options.icon.options,
										i = e.iconSize ? _(e.iconSize) : _(0, 0),
										n = e.iconAnchor ? _(e.iconAnchor) : _(0, 0);
					...
					var qe = ne.extend({
						initialize: function (t, e, i) {
							if (
								(typeof e == 'number' && (e = x({}, i, { radius: e })),
								C(this, e),
								(this._latlng = y(t)),
					...
					var at = dt.extend({
						...
						_convertLatLngs: function (t) {
							for (var e = [], i = q(t), n = 0, o = t.length; n < o; n++)
								i
									? ((e[n] = y(t[n])), this._bounds.extend(e[n]))
					...
					var bt = at.extend({
						...
						_setLatLngs: function (t) {
							(at.prototype._setLatLngs.call(this, t),
								q(this._latlngs) && (this._latlngs = [this._latlngs]));
						},
						_defaultShape: function () {
						...
						switch (i.type) {
							...
							case 'GeometryCollection':
								for (u = 0, c = i.geometries.length; u < c; u++) {
									var d = oe(
										{ geometry: i.geometries[u], type: 'Feature', properties: t.properties },
										e
									);
									d && o.push(d);
								}
					...
					var Ye = {
						toGeoJSON: function (t) {
							return Mt(this, { type: 'Point', coordinates: Ke(this.getLatLng(), t) });
						}
					};
					(ie.include(Ye),
						qe.include(Ye),
						...
						at.include({
							toGeoJSON: function (t) {
								var e = !q(this._latlngs),
									i = re(this._latlngs, e ? 1 : 0, !1, t);
								return Mt(this, { type: (e ? 'Multi' : '') + 'LineString', coordinates: i });
							}
						}),
						bt.include({
							toGeoJSON: function (t) {
								var e = !q(this._latlngs),
									...
									n = re(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
								return (
									e || (n = [n]),
									Mt(this, { type: (i ? 'Multi' : '') + 'Polygon', coordinates: n })
								);
							}
						}),
						Lt.include({
							toMultiPoint: function (t) {
								...
								return (
									...
									Mt(this, { type: 'MultiPoint', coordinates: e })
								);
							},
							toGeoJSON: function (t) {
								...
								return (
									...
									i
										? Mt(this, { geometries: n, type: 'GeometryCollection' })
						...
						he = X.extend({
							...
							onAdd: function () {
								(this._image ||
									...
									this.options.interactive &&
										(v(this._image, 'leaflet-interactive'), this.addInteractiveTarget(this._image)),
					...
					var it = X.extend({
						...
						initialize: function (t, e) {
							(t && (t instanceof b || K(t))
								? ((this._latlng = y(t)), C(this, e))
						...
						onAdd: function (t) {
							((this._zoomAnimated = t._zoomAnimated),
								...
								t._fadeAnimated && V(this._container, 0),
								clearTimeout(this._removeTimeout),
								this.getPane().appendChild(this._container),
								this.update(),
								t._fadeAnimated && V(this._container, 1),
								this.bringToFront(),
								this.options.interactive &&
						...
						onRemove: function (t) {
							(t._fadeAnimated
								? (V(this._container, 0),
									(this._removeTimeout = setTimeout(S(k, void 0, this._container), 200)))
								: k(this._container),
								this.options.interactive &&
					...
					var ue = it.extend({
							...
							openOn: function (t) {
								return (
									...
									(t._popup = this),
									it.prototype.openOn.call(this, t)
								);
							},
							onAdd: function (t) {
								(it.prototype.onAdd.call(this, t),
									...
									this._source &&
										...
										this._source instanceof dt || this._source.on('preclick', vt)));
							},
							onRemove: function (t) {
								(it.prototype.onRemove.call(this, t),
									t.fire('popupclose', { popup: this }),
									this._source &&
										(this._source.fire('popupclose', { popup: this }, !0),
										this._source instanceof dt || this._source.off('preclick', vt)));
							},
							getEvents: function () {
							...
							_updateLayout: function () {
								...
								(o && n > o ? ((e.height = o + 'px'), v(t, s)) : Z(t, s),
							...
							_adjustPan: function () {
								if (this.options.autoPan) {
									...
									var s = t.layerPointToContainerPoint(o),
										...
										c = 0,
										d = 0;
									(s.x + n + h.x > u.x && (c = s.x + n - u.x + h.x),
										s.x - c - a.x < 0 && (c = s.x - a.x),
										s.y + i + h.y > u.y && (d = s.y + i - u.y + h.y),
					...
					(w.mergeOptions({ closePopupOnClick: !0 }),
						...
						X.include({
							bindPopup: function (t, e) {
								return (
									(this._popup = this._initOverlay(ue, this._popup, t, e)),
					...
					var le = it.extend({
							...
							_initLayout: function () {
								...
								((this._contentNode = this._container = T('div', e)),
							...
							_setPosition: function (t) {
								...
								(a === 'top'
									...
									(t = t
										...
										.add(c)
										.add(d)),
									Z(o, 'leaflet-tooltip-right'),
									Z(o, 'leaflet-tooltip-left'),
									Z(o, 'leaflet-tooltip-top'),
									Z(o, 'leaflet-tooltip-bottom'),
									v(o, 'leaflet-tooltip-' + a),
									I(o, t));
							},
							_updatePosition: function () {
								var t = this._map.latLngToLayerPoint(this._latlng);
						...
						X.include({
							bindTooltip: function (t, e) {
								return (
									...
									(this._tooltip = this._initOverlay(le, this._tooltip, t, e)),
					...
					var Wt = X.extend({
						...
						getEvents: function () {
							...
							return (
								this.options.updateWhenIdle ||
									(this._onMove ||
										(this._onMove = Qe(this._onMoveEnd, this.options.updateInterval, this)),
									(t.move = this._onMove)),
						...
						_updateOpacity: function () {
							if (this._map && !f.ielt9) {
								...
								(i && !this._noPrune && this._pruneTiles(),
									e && (G(this._fadeFrame), (this._fadeFrame = D(this._updateOpacity, this))));
							}
						},
						_onOpaqueTile: E,
						_initContainer: function () {
							this._container ||
								((this._container = T('div', 'leaflet-layer ' + (this.options.className || ''))),
								this._updateZIndex(),
							...
							if (e) {
								...
								if ((t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0)) {
									...
									for (var u in this._tiles) {
										...
										(c.z !== this._tileZoom || !h.contains(new m(c.x, c.y))) &&
						...
						_initTile: function (t) {
							...
							((t.style.width = e.x + 'px'),
								...
								(t.onselectstart = E),
								(t.onmousemove = E),
								f.ielt9 && this.options.opacity < 1 && V(t, this.options.opacity));
						},
						_addTile: function (t, e) {
							...
							(this._initTile(o),
								this.createTile.length < 2 && D(S(this._tileReady, this, t, null, o)),
								I(o, i),
					...
					var St = Wt.extend({
						...
						createTile: function (t, e) {
							...
							return (
								p(i, 'load', S(this._tileOnLoad, this, e, i)),
								p(i, 'error', S(this._tileOnError, this, e, i)),
								(this.options.crossOrigin || this.options.crossOrigin === '') &&
						...
						_abortLoading: function () {
							...
							for (t in this._tiles)
								if (
									...
									((e = this._tiles[t].el), (e.onload = E), (e.onerror = E), !e.complete)
								) {
									e.src = jt;
						...
						_removeTile: function (t) {
							var e = this._tiles[t];
							if (e) return (e.el.setAttribute('src', jt), Wt.prototype._removeTile.call(this, t));
						},
						_tileReady: function (t, e, i) {
					...
					var ut = X.extend({
							...
							onAdd: function () {
								(this._container ||
									(this._initContainer(), v(this._container, 'leaflet-zoom-animated')),
									this.getPane().appendChild(this._container),
									this._update(),
					...
					var Ut = (function () {
						...
						Gt = ut.extend({
							_initContainer: function () {
								((this._container = ce('svg')),
									this._container.setAttribute('pointer-events', 'none'),
									(this._rootGroup = ce('g')),
					...
					((Gt.create = ce),
						(Gt.pointsToPath = ai),
						(ht.geometryToLayer = oe),
						(ht.coordsToLatLng = je),
						(ht.coordsToLatLngs = se),
						(ht.latLngToCoords = Ke),
						(ht.latLngsToCoords = re),
						(ht.getFeature = Mt),
						(ht.asFeature = ae),
					...
					var rn = et.extend({
						...
						_finish: function () {
							(this._moved && (k(this._box), Z(this._container, 'leaflet-crosshair')),
								Bt(),
								Ee(),
								M(
									document,
					...
					(w.addInitHook('addHandler', 'boxZoom', rn), w.mergeOptions({ doubleClickZoom: !0 }));
					var an = et.extend({
						addHooks: function () {
					...
					(w.addInitHook('addHandler', 'doubleClickZoom', an),
						w.mergeOptions({
							dragging: !0,
							inertia: !0,
					...
					var hn = et.extend({
						addHooks: function () {
							if (!this._draggable) {
								var t = this._map;
								((this._draggable = new ft(t._mapPane, t._container)),
									this._draggable.on(
							...
							if ((e.fire('dragend', t), n)) e.fire('moveend');
								...
								!g.x && !g.y
									...
									: ((g = e._limitOffset(g, e.options.maxBounds)),
										D(function () {
											e.panBy(g, { duration: d, easeLinearity: r, noMoveStart: !0, animate: !0 });
										}));
							}
						}
					});
					(w.addInitHook('addHandler', 'dragging', hn),
							...
							if (!(t.altKey || t.ctrlKey || t.metaKey)) {
								...
								if (e in this._panKeys) {
									if (!i._panAnim || !i._panAnim._inProgress)
										if (
											((n = this._panKeys[e]),
											t.shiftKey && (n = _(n).multiplyBy(3)),
											i.options.maxBounds && (n = i._limitOffset(_(n), i.options.maxBounds)),
					...
					(w.addInitHook('addHandler', 'keyboard', un),
						w.mergeOptions({
							scrollWheelZoom: !0,
					...
					var cn = et.extend({
						...
						_cancel: function () {
							(clearTimeout(this._holdTimeout),
								M(document, 'touchend touchcancel contextmenu', this._cancel, this),
								M(document, 'touchmove', this._onMove, this));
						},
						_onMove: function (t) {
							var e = t.touches[0];
					...
					(w.addInitHook('addHandler', 'tapHold', cn),
					...
					var fn = et.extend({
						...
						removeHooks: function () {
							(Z(this._map._container, 'leaflet-touch-zoom'),
								M(this._map._container, 'touchstart', this._onTouchStart, this));
						},
						...
						_onTouchEnd: function () {
							...
							((this._zooming = !1),
								G(this._animRequest),
								M(document, 'touchmove', this._onTouchMove, this),
								M(document, 'touchend touchcancel', this._onTouchEnd, this),
					...
					(w.addInitHook('addHandler', 'touchZoom', fn),
						(w.BoxZoom = rn),
						(w.DoubleClickZoom = an),
						(w.Drag = hn),
						(w.Keyboard = un),
						(w.ScrollWheelZoom = ln),
						(w.TapHold = cn),
						(w.TouchZoom = fn),
						(l.Bounds = z),
						(l.Browser = f),
...
var vn = Yo();
const Xo = jo(vn),
	Jo = qo({ __proto__: null, default: Xo }, [vn]);
export { Jo as l };
