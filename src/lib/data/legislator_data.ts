...
const createRep = (name: string, district: string, party: 'R' | 'D', stance: Stance = 'undecided'): Legislator => ({
...
const createSen = (name: string, district: string, party: 'R' | 'D', stance: Stance = 'undecided'): Legislator => ({
    id: name.toLowerCase().replace(/ /g, '-'),
    name,
    chamber: 'senate',
    district,
...
export const houseJudiciaryNonCivilMembers: Legislator[] = [
    { ...createRep('Tyler Paul Smith', '18', 'R', 'target'), roles: [{ title: 'Committee Chair', priority: 1 }] },
    { ...createRep('Deborah Silcox', '53', 'R', 'target'), roles: [{ title: 'Vice Chair', priority: 2 }] },
...
export const senateJudiciaryMembers: Legislator[] = [
    { ...createSen('Brian Strickland', '17', 'R', 'target'), roles: [{ title: 'Committee Chair', priority: 1 }] },
