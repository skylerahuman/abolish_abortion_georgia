...
<div class="min-h-screen flex flex-col bg-black text-white">
	...
	<a
		href="#main-content"
		class="absolute -top-96 left-4 z-[100] rounded-sm border border-white/20 bg-crimson px-6 py-3 font-bold uppercase tracking-widest text-white shadow-lg transition-all duration-300 focus:top-4"
	>
		Skip to Content
	</a>
			...
			<div class="flex justify-between items-center h-16">
				...
				<div class="flex items-center space-x-3">
					...
					<div>
						...
						<p class="text-[10px] text-neutral-500 tracking-widest uppercase font-bold">Georgia</p>
					</div>
				</div>
				...
				<div class="hidden md:flex md:items-center md:space-x-1">
					...
					{/each}
					<a href="{base}/join" class="ml-4 px-4 py-2 bg-red-600 text-white text-[10px] font-bold uppercase tracking-widest rounded-sm hover:bg-red-700 transition-colors">
						Join the Fight
					</a>
				</div>
	...
	<footer class="bg-black text-neutral-400 py-24 border-t border-neutral-900">
		<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
			<!-- Scripture Focus -->
			<div class="space-y-6">
				<div class="text-white font-serif font-bold text-2xl md:text-3xl leading-tight">
