...
<div class="min-h-screen flex flex-col bg-black text-white">
	...
	<a
		href="#main-content"
		class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-[100] bg-white text-black px-4 py-2 font-bold rounded-sm ring-2 ring-red-600 transition-all duration-200"
	>
			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div class="flex justify-between items-center h-16">
					...
					<div class="flex items-center">
						<button
							onclick={toggleMenu}
							class="md:hidden text-red-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-600 rounded-sm"
