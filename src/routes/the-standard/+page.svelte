...
<svelte:head>
    <title>The Standard | Abolition Georgia</title>
</svelte:head>
...
<div class="bg-black text-white min-h-screen py-12 font-sans selection:bg-red-900 selection:text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center">
            ...
            <a href="{base}/the-plea" class="text-red-500 font-bold uppercase tracking-widest text-sm border-b border-red-900 hover:text-red-400 hover:border-red-500 transition-all pb-1">
                Make The Plea &rarr;
            </a>
        </div>
    </div>
