...
- **Strategy:**
  ...
  - **Avoid** testing implementation details (internal variables); test the _user-facing_ behavior.
...
- **E2E:** Use `page.route()` to intercept and mock network requests.
  - _Do not_ rely on live 3rd party APIs in tests.
  - _Do not_ introduce MSW (Mock Service Worker) at this stage.
